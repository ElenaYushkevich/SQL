...
2. Какие есть подмножества SQL? ddl dml dcl
...
7. Primary key уник нот нал и автинкремент
...
8. Какие есть ограничения на столбиках при создании? (primary key, foreign key, not null, default, ...6шт)
...
15. Что такое сущности в БД? реляции и обжект
...
16. Что такое отношения в БД? реляции и обжект
...
19. Что такое свойства acid (атомарность, согласованность, изолированность, долговечность)?
...
20. Какие операторы доступны в SQL (арифметические, логические, сравнения)?
...
21. РАвны ли значения null, ноль и пробел?
...
22. какая разница между cross join и natural join?
...
ANYозначает, что условие будет истинным, если операция истинна для любого из значений в диапазоне.
...
25. Какие бывают типы подзапросов (корелированные и некорелерированные)?
